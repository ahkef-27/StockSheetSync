...
1日分が蓄積されると、グラフはこのように完成します

補足 終盤のスパイクや安定した推移が一目で把握できます
...
数時間でここまで蓄積され、グラフも動き出します

Metaの急落やGoogleの微増など、変動が視覚化されます

ただ、市場取引時間の5時をすぎて一回分カウントしているので、そこは修正すべき点だと考えています
