...
2️⃣ 一時シート temp の生成と削除

各実行時に、データ格納用の temp シートが自動生成。
...
処理完了後、temp シートは自動削除されます。

これらによって、1日分の動きがひと目で把握できるようになっており、基本的には下の週次グラフのような画面になります：
...
グラフの緩い変化で変化が分かりづらいことと、急騰・急落でグラフが切れてしまう問題に対応する
